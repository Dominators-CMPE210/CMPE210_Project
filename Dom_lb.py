...
controllerip = IPAddr("50.0.0.10")
controllermac = EthAddr("00:00:00:00:00:10")

server = {}
server[0] = {'ip':IPAddr("50.0.0.2"), 'mac':EthAddr("00:00:00:00:00:02"), 'outport': 2}
server[1] = {'ip':IPAddr("50.0.0.3"), 'mac':EthAddr("00:00:00:00:00:03"), 'outport': 3}
server[2] = {'ip':IPAddr("50.0.0.4"), 'mac':EthAddr("00:00:00:00:00:04"), 'outport': 4}
...
def _handle_PacketIn (event):
    ...
    reverse_msg.actions.append(of.ofp_action_dl_addr(of.OFPAT_SET_DL_SRC, controllermac))
    reverse_msg.actions.append(of.ofp_action_nw_addr(of.OFPAT_SET_NW_SRC, controllerip))
...
def launch ():
    ...
    log.info("Load balancer working.")
